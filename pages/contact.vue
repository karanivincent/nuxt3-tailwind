    ...
    <div class="bg-white pt-12">
      <div class="max-w-5xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div class="max-w-lg mx-auto md:max-w-none md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h2 class="text-xl font-extrabold text-gray-900 uppercase">Sales Support</h2>
            <!-- <div class="mt-3">
              <p
            ...
            <div class="mt-9">
              ...
              <a href="mailto:info@synergypwrsystems.co.ke" class="mt-6 flex">
                <div class="flex-shrink-0">
                  <svg
                    class="w-6 h-6 text-gray-400"
                    aria-hidden="true"
                ...
                <div class="ml-3 text-base text-gray-500">
                  <p>info@synergypwrsystems.co.ke</p>
                </div>
              </a>
            </div>
          </div>
          <div class="mt-12 sm:mt-16 md:mt-0">
            <h2 class="text-xl font-extrabold text-gray-900 uppercase">Technical Support</h2>

            <div class="mt-9">
              <a href="https://wa.me/254710777800" class="flex">
